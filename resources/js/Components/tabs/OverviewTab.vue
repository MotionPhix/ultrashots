...
import { IconAlbum, IconBuildingArch, IconMail, IconMap2, IconNote, IconNotes, IconPhone } from '@tabler/icons-vue';
...
<template>
  <section
    class="py-6 flex-1 flex-col xl:flex-row flex-grow flex gap-10">
    ...
    <div class="space-y-8">
      ...
      <section
        ...
        <div class="w-full space-y-2">
          ...
          <p
            ...
            class="flex items-center justify-between border-b last:border-b-0 pb-2"
            :key="phone.id">
            <strong>
              {{ phone.formatted }}
            </strong>
      ...
      <section
        ...
        <div class="w-full space-y-2">
          ...
          <p
            ...
            class="flex flex-col gap-2 border-b last:border-b-0 pb-2"
            :key="address.id">
      ...
      <section
        ...
        <div class="w-full">
          ...
          <div class="empty:hidden flex flex-col items-center gap-3 text-gray-500" v-else>
            <IconNote class="text-gray-400 h-48 w-48" stroke-width="1" />

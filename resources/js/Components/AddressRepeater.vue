...
<template>
  <div
    v-for="(address, idx) in modelValue"
    :key="idx"
  ...
  <div>
    <Menu as="div" class="relative inline-flex">
      ...
      >
        <MenuItems class="absolute left-0 z-20 w-48 mt-2 overflow-hidden origin-top-left bg-white border rounded-md shadow-lg focus:outline-none">

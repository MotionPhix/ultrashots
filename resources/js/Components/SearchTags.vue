...
<template>
  <div class="relative tag-input">
    ...
    <article
      class="absolute right-0 w-48 bg-white rounded-lg shadow dark:border dark:border-gray-500 bottom-full dark:bg-gray-700 dark:divide-gray-600"
      v-if="inputVisible">

      <OnClickOutside @trigger="inputVisible = false">
        <ul v-if="inputVisible">
          <li>
            <input
              v-model="searchTerm"

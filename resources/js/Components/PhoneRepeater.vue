  ...
  <div v-for="(phone, idx) in modelValue" :key="idx" class="relative mb-4 space-y-2 group first-letter:uppercase">
    ...
    <MazPhoneNumberInput
      ...
      <!-- <template #selector-flag="{ countryCode }">
        <span
          style="padding-right: 4px; padding-left: 4px; font-size: 0.8rem; background-color: var(--maz-color-secondary); color: var(--maz-color-secondary-contrast); border-radius: 100px;"
        >
          {{ countryCode }}
        </span>
      </template>

...
const locale = "en"
const projectId = 214012 // replace with your project id
const tools = {
  // disable image tool
  image: {
    enabled: true
...
7B9p0XAlwitmfb5YLqAAvt8MMubnwiF7bz4dz3q0fs4VcpNNETWoTrTp8wGxd64Z
<div id="editor"></div>
<script>
  unlayer.init({
    id: 'editor',
...
.container {
  @apply bg-rose-600 rounded-lg overflow-hidden
}

            ...
            <UltraDropdown
              ...
              <template #menuitem-label="{item}">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <svg v-if="item.label === 'Dashboard'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
                  ...
                  <svg v-if="item.label === 'Settings'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
